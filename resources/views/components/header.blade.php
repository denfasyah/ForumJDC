...
<body class="bg-Background">
    ...
    <div class="navbar bg-Blue shadow-md fixed z-30">
        <div class="navbar-start">
            ...
            <div class="hidden lg:flex">
                <ul class="menu-horizontal px-1 lg:ml-10 md:ml-5 sm:ml-2">
                    ...
                    <li>
                        <a href="#" class="text-white mx-5 font-inter" onclick="tagsModal.showModal()">Tags</a>
                    </li>
                    <li>
        ...
        <div class="navbar-center ml-2">
            <!-- Search bar -->
            <div class="join">
                <input class="bg-DarkBlue input join-item rounded-l-full  text-white placeholder-slate-200 lg:pr-2 md:pr-2 focus:outline-none focus:border-none"
                    placeholder="Search here" />
                <button class="bg-DarkBlue border-none join-item rounded-r-full">
                    <img src="{{ asset('svg/search.svg') }}" alt="Search Icon" class="mr-3">
                </button>
            </div>
        </div>
        ...
        <div class="navbar-end relative">
            ...
            <a href="#" class="ml-5">
                <img src="{{ asset('svg/bookmartNav.svg') }}" alt="BookmartNav Icon">
            </a>
            <a href="#" class="mx-5">
                <img src="{{ asset('svg/notificationNav.svg') }}" alt="NotificationNav Icon">
            </a>
            <a href="#" class="">
                <div class="dropdown dropdown-end">
                    <div tabindex="0" class="">
                        <div class="w-10 rounded-full">
                        <img src="{{ asset('svg/profileNav.svg') }}" alt="ProfileNav Icon">
                        </div>
                    </div>
                    <ul tabindex="0" class="menu  menu-sm dropdown-content mt-5 z-[1] pb-3 shadow bg-base-100 rounded-box w-28">
                        <li><a href="/login" class="text-md font-medium">Login</a></li>
                        <hr class="my-1.5">
                        <li><a href="/register" class="text-md font-medium">Register</a></li>
                    </ul>
                </div>
            </a>
            <a href="#" class="mr-2 ml-10">
                <img src="{{ asset('svg/settingsNav.svg') }}" alt="ProfileNav Icon">
            </a>
        </div>
        ...
        <div class="dropdown">
            <div tabindex="0" role="button" class="lg:hidden">
                    <img src="{{ asset('svg/hamburger.svg') }}" alt="Hamburger-Menu" class="h-7 w-7 font-bold mr-2 ">
            </div>
                <ul tabindex="0" class="menu menu-sm dropdown-content mt-5 z-[1] p-2 shadow rounded-box w-52 overflow-y-auto right-0 origin-top-right absolute bg-black">
                    <li><a class="text-white">Home</a></li>
                    <li><a class="text-white">Tags</a></li>
                    <li><a class="text-white">Popular</a></li>
                    <div class="flex mt-2">
                    <a href="#" class=""><svg width="25" height="25" fill="none" stroke="#f0efef" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" class=""><svg width="32" height="32" fill="#f0efef" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" class=""><svg width="26" height="26" fill="none" stroke="#f0efef" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <dialog id="tagsModal" class="modal">
                        <div class="modal-box absolute top-0 mt-20 border-2 border-Blue">
                            ...
                            <form class="flex justify-center items-center mt-2" method="dialog">
                                <button class="mt-4 bg-Blue mr-2 text-white px-7 py-1 text-sm rounded-md hover:bg-DarkBlue"
                                    onclick="closeCategoryModal()">Save</button>
                                <button class="mt-4 bg-Blue text-white px-6 py-1 text-sm rounded-md hover:bg-DarkBlue">Cancel</button>
                            </form>
                        </div>
                    </dialog>
