...
@section('explore')
    <div class="container mt-5">
        <div class="bg-white rounded-2xl p-5">
            <div class="flex justify-between">
                <div class="flex items-start -space-y-1 gap-3">
                    <div class="avatar flex items-center">
                        <diqv class="mask mask-circle w-5 lg:w-12 md:w-14 sm:w-8 mx-auto">
                            <img src="{{ asset('icon/anime.png') }}" />
                    </div>
                    <div class="flex flex-col">
                        <span class="font-bold text-xs lg:text-lg md:text-lg sm:text-md mt-1">Adent</span>
            ...
            {{-- Messages --}}
            <p class="text-xs lg:text-sm md:text-sm sm:text-sm font-medium p-3">
                eat > sleep > code 😋
            </p>
            {{--  --}}
            <div class="mt-5">
            ...
            <div class="flex gap-5 relative mx-3">
                @livewire("LikesButton")
                @livewire("DisLikesButton")
                <div class="flex items-baseline">
                    <!-- icon message -->
                    <a href="#">
                        <svg class="w-3 lg:w-5 md:w-5 sm:w-5 mt-0.5" fill="none" stroke="#bfbfbf" stroke-linecap="round"
