...
<body class="m-0 font-sans text-base antialiased font-normal leading-default text-slate-500">
        ...
        <div class="h-19.5">
            ...
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="/">
                <img src="./assets/img/logo-ct.png"
                    ...
                    alt="main_logo" />
                <span class="ml-1 transition-all text-lg text-Blue font-bold duration-200 ease-nav-brand">Junior
                    Developer</span>
      class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent"
    >
      <div class="h-19.5">
        ...
        >
          ...
          /> -->
          <span
            class="ml-1 transition-all text-lg text-Blue font-bold duration-200 ease-nav-brand font-inter"
      ...
      >
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="@if (request()->is('explore')) shadow-soft-2xl rounded-lg bg-white @endif py-2.5 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('explore') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                ...
                <li class="mt-0.5 w-full">
                    <a class="@if (request()->is('event')) shadow-soft-2xl rounded-lg bg-white @endif py-2.5 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('event') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                ...
                <li class="mt-0.5 w-full">
                    <a class="@if (request()->is('learning')) shadow-soft-2xl rounded-lg bg-white @endif py-2.5 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('learn') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
          ...
          <li class="mt-0.5 flex justify-center w-full">
            ...
            <dialog id="my_modal_about" class="modal">
              <div class="modal-box">
                ...
                <li class="mt-0.5 w-full">
                    <a class="@if (request()->is('quest')) shadow-soft-2xl rounded-lg bg-white @endif py-2.5 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('quest') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                ...
                <li class="mt-0.5 w-full">
                    <a class="@if (request()->is('job')) shadow-soft-2xl rounded-lg bg-white @endif py-2.5 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('job') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                ...
                @if (request()->is('event'))
                    <hr
                        class="h-px mt-5 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />
                    <li class="mt-0.5 flex justify-center w-full">
                        <button class="mx-6 w-full bg-Blue text-white rounded lg:px-10 md:px-7 sm:px-5 px-4 py-1"
                            class="mx-5 w-full rounded mr-5 bg-Blue text-white lg:px-10 md:px-7 sm:px-5 px-4 py-1"
                            onclick="my_modal_about.showModal()">
                            Create
                        </button>
                    ...
                    @endif @if (request()->is('job'))
                        <hr
                            class="h-px mt-5 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />
                        <li class="mt-0.5 flex justify-center w-full">
                            <button class="mx-5 w-full rounded bg-Blue text-white lg:px-10 md:px-7 sm:px-5 px-4 py-1"
                                onclick="my_modal_about.showModal()">
                                Create
                            </button>
                            <dialog id="my_modal_about" class="modal">
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        @elseif(request()->is('learning'))
                            <a href="{{ route('learn') }}"
                                class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                                aria-current="page">Learning</a>
                        @elseif(request()->is('job'))
                            <a href="{{ route('job') }}"
                                class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                                aria-current="page">Job</a>
                        @elseif(request()->is('quest'))
                            <a href="{{ route('quest') }}"
                                class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                                aria-current="page">Quest</a>
                ...
                <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    <div class="flex items-center md:ml-auto md:pr-4">
                        <div class="relative flex flex-wrap items-stretch w-full transition-all ease-soft">
                            <span
    ...
    >
      <!-- Navbar -->
      <nav
        class="relative my-4 flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start"
        navbar-main
        navbar-scroll="true"
      >
        <div
        ...
        >
          <nav>
            ...
            <h6 class="mb-0 font-bold capitalize">Event</h6>
            @elseif(request()->is('detailevent'))
            <h6 class="mb-0 font-bold capitalize">Detail Event</h6>
            @elseif(request()->is('learning'))
            <h6 class="mb-0 font-bold capitalize">Learning</h6>
            @elseif(request()->is('quest'))
            <h6 class="mb-0 font-bold capitalize">Questions</h6>
            ...
            <h6 class="mb-0 font-bold capitalize">Job</h6>
            @elseif(request()->is('detailjob'))
            <h6 class="mb-0 font-bold capitalize">Detail Job</h6>
            @elseif(request()->is('profile'))
            <h6 class="mb-0 font-bold capitalize">Profile</h6>
            @endif
          </nav>
          ...
          >
            ...
            @guest
              <li>
                <a
                  href="/login"
                  class="w-full rounded bg-Blue text-white lg:px-10 md:px-7 sm:px-5 px-4 py-1"
                  >Login</a
                >
              </li>
              @endguest
