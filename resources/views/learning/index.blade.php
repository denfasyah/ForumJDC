    ...
    <div class="container mt-5">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div
                ...
                <a href="{{ route('learnWithType',['type' => "belajar-html-dasar"]) }}">
                  ...
                  <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                    ...
                    <span class="mt-28 mb-0 font-semibold leading-normal text-white group text-sm">
                      Learn
                      <i
            ...
            <div
                class="relative flex flex-col h-full min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <a href="{{ route('learnWithType',['type' => "belajar-css-dasar"]) }}">
                  <div class="relative h-full overflow-hidden bg-cover rounded-xl"
