                        ...
                        <div class="relative right-0 ">
                            <ul class="relative flex flex-wrap gap-5 p-1 list-none bg-transparent rounded-xl" nav-pills
                                ...
                                <li class="flex-auto text-center">
                                    <a class="block w-full px-0 py-1 mb-0 transition-colors border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700"
                                        nav-link href="javascript:;" role="tab" aria-selected="false">
                                    ...
                                    <div class="dropdown dropdown-bottom dropdown-end">
                                        ...
                                        <ul tabindex="0"
                                            ...
                                            @foreach ($user->socialMedia->sortByDesc('platform_id') as $item)
                                                <li>
                                                    <div class="">
                                                        <a href="{{ $item->platform->link . $item->username }}" class="flex items-center gap-2">
                                                          <img
                                                                src="{{ asset('icon/' . $item->platform-> images) }}"
